<?php
define('DIR', LIVE ? '/waddd2/' : '/workspace/WA-DDD/');
define('DOMAIN', LIVE ? 'www.statedata.info' : $_SERVER['HTTP_HOST']);
define('DATA_DIR', LIVE ? '/home/statedata/wa-ddd' : '/Users/cnagle/workspace/WA-DDD/data/');
define('DEBUG', LIVE ? 0 : 1);
define('TEMPLATE', 'waddd_template');
define('ADMIN_EMAIL', 'frank.smith@umb.edu');
...
define('REGEX_PROVIDER_NUMBER', '/^P\d{5,8}[A-Za-z]?(?:,P\d{5,8}[A-Za-z]?)*$/');
