...
var $permissions = array(
	 ...
	 */
	function insert_registration_data($username, $password, $provider_id, $mask_id, $group_id, $email) {
	...
	function add_user() {
		...
		$provider_id = (isset($_GET['provider_id']) && is_numeric($_GET['provider_id']) && $_GET['provider_id'] > -1) ? $this->qls->Security->make_safe($_GET['provider_id']) : 0;
		...
		$this->insert_registration_data($username, $password, $provider_id, $mask_id, $group_id, $email);
		return true;
		}
		else {
	 ...
	 */
	function insert_new_user_data($user_id, $new_username, $new_provider_id, $new_mask_id, $new_group_id, $new_email, $new_banned) {
	...
	$new_provider_id = (isset($_GET['new_provider_id']) && is_numeric($_GET['new_provider_id']) && $_GET['new_provider_id'] > -1) ? $this->qls->Security->make_safe($_GET['new_provider_id']) : 0;
	...
	$this->insert_new_user_data($user_id, $new_username, $new_provider_id, $new_mask_id, $new_group_id, $new_email, $new_banned);
	return true;
	}
