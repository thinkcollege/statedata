...
define('REGISTER_LINK', '<a href="register_md.php">register</a>');
define('LOGIN_LINK', '<a href="login_md.php">login</a>');
define('MEMBER_LINK', '<a href="members_md.php">member section</a>');
define('LOGOUT_LINK', '<a href="logout_md.php">logout</a>');
...
//DMR customizations
define('PROVIDER_LABEL', 'Provider');
define('NEW_PROVIDER_LABEL', 'Provider');
define('ICI_ADMIN_LABEL', 'ICI Admin');
?>