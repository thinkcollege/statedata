...
var $permissions = array(
	...
	function add_user() {
		...
		$provider_id = (isset($_GET['provider_id']) && strlen($_GET['provider_id']) < 12) ? $this->qls->Security->make_safe($_GET['provider_id']) : 0;
	...
	$new_provider_id = (isset($_GET['new_provider_id']) && strlen($_GET['new_provider_id']) < 12) ? $this->qls->Security->make_safe($_GET['new_provider_id']) : 0;
