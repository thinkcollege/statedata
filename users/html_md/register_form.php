...
<fieldset>
	...
	<form action="register_md.php<?php if (isset($_GET['code'])) { ?>?code=<?php echo htmlentities($_GET['code']); } ?>" method="post">
...
?>
			<tr>
				<td colspan="2" align="center">
					<img src="security_image_md.php?id=<?php echo $random_id; ?>" border="0" alt="Security Image" />
				</td>
			</tr>
			<tr>
				<td>
