...
<fieldset>
	...
	<table border="0" cellspacing="3" cellpadding="2">
		<tr>
			...
			<th style="border-left: 1px solid #000;text-align:left; border-right: 1px solid #000;text-align:left;"><?php echo REMOVE_LABEL; ?></th><th style="border-left: 1px solid #000;text-align:left;">Last login</th>
		</tr>
<?php
...
?>
		<tr>
			...
			</td><td><?php $last_login = date("Y-m-d, H:i:s",$users_row['last_login']); echo $last_login; ?></td>
		</tr>
<?php
	}
?>
