...
if ($qls->User->check_password_code()) {
	...
	require_once('html_md/change_password_form.php');
	}
}
else {
	...
	if (!isset($_GET['code'])) {
		...
		require_once('html_md/request_password_change_form.php');
		}
	}
	else {
