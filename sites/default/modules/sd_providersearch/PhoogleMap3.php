...
function centerMap($lat,$long){
    $this->centerMap = "var location = new GLatLng(".$lat.",".$long.");\n
		map.setCenter(location,".$this->zoomLevel.");\n";
}
...
for ($g = 0; $g<$numPoints; $g++){
    echo "var point".$g." = new GLatLng(".$this->validPoints[$g]['lat'].",".$this->validPoints[$g]['long'].");\n
		var marker".$g." = new GMarker(new GLatLng(".$this->validPoints[$g]['lat'].",".$this->validPoints[$g]['long']."));\n
