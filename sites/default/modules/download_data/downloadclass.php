...
public function __construct($site = 'statedata' ) {
	...
	$results = db_query("Select downloadid, tablename, displayname, downloadFile, descriptionFile,lookup_table, lookup_field , isadmin from {download_data} where site ='" . $this->_site ."'")->fetchAll(PDO::FETCH_ASSOC);
$this->downloadsAry = $results;
