...
class mre_base {
	...
	function mre_base() {
		...
		$this->mre_base_sitename="SiteName";
		$this->mre_base_path="/home/statedata/statedata.info/htdocs/x/";
		$this->mre_base_webpath="http://statedata.info/x/";
