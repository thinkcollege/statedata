...
*/
function getRegions($element_name, $showAll = 1, $provider = 'ALL', $regiontype='normal', $provider_id = 0) {
...
function getRegionVariables() {
	...
	for($i=0; $i<count($this->ar_region_variables); $i++) {
		$html= $html . "<br style='clear:both' /><span style='width:25px;'><input type=radio name=variable id=$i value='".$this->ar_region_variables[$i]."'></span><span><label  for='$i'>". $this->ar_region_variables_name[$i] ."</label></span><br style='clear:both' />\n";
	}
