...
$template->define_file($print ? 'dds_print_template.php' : 'mdda_template.php');
...
$values	= implode(';', mdda::getRegionVariableArray($var, $f['year']));
$cats	= preg_replace('/(^|;)x_/i', '\\1', implode(';', mdda::getRegionColumnNamesArray($f['year'])));
$axis	= mdda::getRegionAxisLabel($var);
$legend	= mdda::getRegionLegendName($var, $f['year']);
...
if (!$print) {
	$html .= "<br><a target=\"_new\" href=\"region_2.php?print=1&amp;variable=$var&amp;" . mdda::serializeFilters() . "\">Printer-Friendly Format</a>";
}
