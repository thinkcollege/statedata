...
function getRegions($element_name, $showAll = 1, $provider = 'ALL', $regiontype='normal') {
	...
	if ($provider == 'ALL'){
		$results = $database->query("Select distinct region from spec_dmr4 where region != 'x' order by region");
	} else {
		$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' order by region");
	}
	...
	if ($_SERVER['PHP_AUTH_USER'] =='dmruser') {
		if ($regiontype=='normal') {
			...
			$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' and CRS_contract in ( " . $this->getContractNumbers ('Berkshire') . ") ");
			if ( $database->num_rows($results) > 0 ) {
				$html= $html . "<option value='x_Berkshire'>Berkshire</option>\n";
			}

			$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' and CRS_contract in ( " . $this->getContractNumbers ('Franklin/Hampshire') . ") ");
			if ( $database->num_rows($results) > 0 ) {
				$html= $html . "<option value='x_Franklin/Hampshire'>Franklin/Hampshire</option>\n";
			}

			$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' and CRS_contract in ( " . $this->getContractNumbers ('Springfield/Westfield') . ") ");
			if ( $database->num_rows($results) > 0 ) {
				$html= $html . "<option value='x_Springfield/Westfield'>Springfield/Westfield</option>\n";
			}

			$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' and CRS_contract in ( " . $this->getContractNumbers ('Holyoke/Chicopee') . ") ");
			if ( $database->num_rows($results) > 0 ) {
				$html= $html . "<option value='x_Holyoke/Chicopee'>Holyoke/Chicopee</option>\n";
			}
			$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' and LEFT( CRS_Contract, 1 ) = '". $this->getContractNumbers ('West') ."'  ");

			if ( $database->num_rows($results) > 0 ) {
				$html= $html . "<option value='x_West'>West</option>\n";
			}
			$results = $database->query("Select distinct region from spec_dmr4 where vendor = '$provider' and LEFT( CRS_Contract, 1 ) = '". $this->getContractNumbers ('Central') ."' ");
			if ( $database->num_rows($results) > 0 ) {
				$html= $html . "<option value='x_Central'>Central</option>\n";
			}
		}
...
function getProviders($element_name, $region, $showAll = 1) {
	...
	if ($region == 'ALL' || $region=='0') {
		$query = "Select distinct vendor from spec_dmr4 order by vendor";
	} else {
		if (substr_count($region, "x_") > 0 ) {
			$region = substr($region,2);
			if ($region =='Central' || $region == 'West') {
				$query = "Select distinct vendor from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '". $this->getContractNumbers ($region) ."' order by vendor";
			} else {
				$query = "Select distinct vendor from spec_dmr4 where CRS_Contract in (". $this->getContractNumbers($region) .") order by vendor";
			}
		} else {
			$query = "Select distinct vendor from spec_dmr4 where region='". $region ."' order by vendor";
		}
	}
...
function getRegionVariableArray ($variable, $year) {
	...
	for($i=0; $i<count($arRegions); $i++) {
		...
		if ($variable == 'Num_HrsInd') {
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsInd is not null and HrsInd != 0" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsInd is not null and HrsInd != 0" . $whereClause;
				}
			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsInd is not null and HrsInd != 0" . $whereClause;
			}
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsGroup is not null and HrsGroup != 0" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsGroup is not null and HrsGroup != 0" . $whereClause;
				}
			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsGroup is not null and HrsGroup != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsFac is not null and HrsFac != 0" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsFac is not null and HrsFac != 0" . $whereClause;
				}
			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsFac is not null and HrsFac != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsTransition is not null and HrsTransition != 0" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsTransition is not null and HrsTransition != 0" . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsTransition is not null and HrsTransition != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' " . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") " . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' " . $whereClause;
			}
			$results = $database->query($query);
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(HrsInd) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsInd is not null and HrsInd != 0" . $whereClause;
				} else {
					$query = "Select avg(HrsInd) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsInd is not null and HrsInd != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(HrsInd) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsInd is not null and HrsInd != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				...
				if ($useIn == false) {
					$query = "Select avg(hrsGroup) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and hrsGroup is not null and hrsGroup != 0" . $whereClause;
				} else {
					$query = "Select avg(hrsGroup) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and hrsGroup is not null and hrsGroup != 0" . $whereClause;
				}
			} else {
				$query = "Select avg(hrsGroup) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and hrsGroup is not null and hrsGroup != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(HrsFac) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsFac is not null and HrsFac != 0" . $whereClause;
				} else {
					$query = "Select avg(HrsFac) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsFac is not null and HrsFac != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(HrsFac) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsFac is not null and HrsFac != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(HrsVolunteer) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
				} else {
					$query = "Select avg(HrsVolunteer) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(HrsVolunteer) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(HrsTransition) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsTransition is not null and HrsTransition != 0" . $whereClause;
				} else {
					$query = "Select avg(HrsTransition) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsTransition is not null and HrsTransition != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(HrsTransition) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsTransition is not null and HrsTransition != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(dol_ind/HrsInd) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsInd is not null and HrsInd != 0 and dol_ind is not null and dol_ind != 0" . $whereClause;
				} else {
					$query = "Select avg(dol_ind/HrsInd) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsInd is not null and HrsInd != 0 and dol_ind is not null and dol_ind != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(dol_ind/HrsInd) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsInd is not null and HrsInd != 0 and dol_ind is not null and dol_ind != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(dol_group/hrsGroup) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and hrsGroup is not null and hrsGroup != 0 and dol_group is not null and dol_group != 0" . $whereClause;
				} else {
					$query = "Select avg(dol_group/hrsGroup) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and hrsGroup is not null and hrsGroup != 0 and dol_group is not null and dol_group != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(dol_group/hrsGroup) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and hrsGroup is not null and hrsGroup != 0 and dol_group is not null and dol_group != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select  avg(dol_facility/HrsFac) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsFac is not null and HrsFac != 0 and dol_facility is not null and dol_facility != 0" . $whereClause;
				} else {
					$query = "Select  avg(dol_facility/HrsFac) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsFac is not null and HrsFac != 0 and dol_facility is not null and dol_facility != 0" . $whereClause;
				}

			} else {
				$query = "Select  avg(dol_facility/HrsFac) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsFac is not null and HrsFac != 0 and dol_facility is not null and dol_facility != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select sum(HrsInd) as part from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsInd is not null and HrsInd != 0" . $whereClause;
				} else {
					$query = "Select sum(HrsInd) as part from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsInd is not null and HrsInd != 0" . $whereClause;
				}

			} else {
				$query = "Select sum(HrsInd) as part from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsInd is not null and HrsInd != 0" . $whereClause;
			}
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select sum(totalHours) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' " . $whereClause;
				} else {
					$query = "Select sum(totalHours) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") " . $whereClause;
				}

			} else {
				$query = "Select sum(totalHours) as total from spec_dmr4 where region='" . $arRegions[$i] . "' " . $whereClause;
			}
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select sum(HrsGroup) as part from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsGroup is not null and HrsGroup != 0" . $whereClause;
				} else {
					$query = "Select sum(HrsGroup) as part from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsGroup is not null and HrsGroup != 0" . $whereClause;
				}

			} else {
				$query = "Select sum(HrsGroup) as part from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsGroup is not null and HrsGroup != 0" . $whereClause;
			}
			$results = $database->query($query);
			$part = $database->fetch_result($results,$result,'part');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select sum(HrsFac) as part from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsFac is not null and HrsFac != 0" . $whereClause;
				} else {
					$query = "Select sum(HrsFac) as part from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsFac is not null and HrsFac != 0" . $whereClause;
				}

			} else {
				$query = "Select sum(HrsFac) as part from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsFac is not null and HrsFac != 0" . $whereClause;
			}
			$results = $database->query($query);
			$part = $database->fetch_result($results,$result,'part');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select sum(HrsVolunteer) as part from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
				} else {
					$query = "Select sum(HrsVolunteer) as part from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
				}

			} else {
				$query = "Select sum(HrsVolunteer) as part from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsVolunteer is not null and HrsVolunteer != 0" . $whereClause;
			}
			$results = $database->query($query);
			$part = $database->fetch_result($results,$result,'part');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select sum(HrsTransition) as part from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and HrsTransition is not null and HrsTransition != 0" . $whereClause;
				} else {
					$query = "Select sum(HrsTransition) as part from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and HrsTransition is not null and HrsTransition != 0" . $whereClause;
				}

			} else {
				$query = "Select sum(HrsTransition) as part from spec_dmr4 where region='" . $arRegions[$i] . "' and HrsTransition is not null and HrsTransition != 0" . $whereClause;
			}
			$results = $database->query($query);
			$part = $database->fetch_result($results,$result,'part');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(dol_ind) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and dol_ind is not null  and dol_ind != 0" . $whereClause;
				} else {
					$query = "Select avg(dol_ind) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and dol_ind is not null  and dol_ind != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(dol_ind) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and dol_ind is not null  and dol_ind != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(dol_group) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and dol_group is not null  and dol_group != 0" . $whereClause;
				} else {
					$query = "Select avg(dol_group) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and dol_group is not null  and dol_group != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(dol_group) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and dol_group is not null  and dol_group != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select avg(dol_Facility) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and dol_Facility is not null  and dol_Facility != 0" . $whereClause;
				} else {
					$query = "Select avg(dol_Facility) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and dol_Facility is not null  and dol_Facility != 0" . $whereClause;
				}

			} else {
				$query = "Select avg(dol_Facility) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and dol_Facility is not null  and dol_Facility != 0" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as ys from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and trim(YNInd) = 'Y'" . $whereClause;
				} else {
					$query = "Select count(*) as ys from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and trim(YNInd) = 'Y'" . $whereClause;
				}

			} else {
				$query = "Select count(*) as ys from spec_dmr4 where region='" . $arRegions[$i] . "' and trim(YNInd) = 'Y'" . $whereClause;
			}
			$results = $database->query($query);
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and ( trim(YNInd) in ('Y','N')) " . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and ( trim(YNInd) in ('Y','N')) " . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and ( trim(YNInd) in ('Y','N')) " . $whereClause;
			}
			$results = $database->query($query);
			$total = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as ys from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and trim(YNGroup) = 'Y'" . $whereClause;
				} else {
					$query = "Select count(*) as ys from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and trim(YNGroup) = 'Y'" . $whereClause;
				}

			} else {
				$query = "Select count(*) as ys from spec_dmr4 where region='" . $arRegions[$i] . "' and trim(YNGroup) = 'Y'" . $whereClause;
			}
			$results = $database->query($query);
			$ys = $database->fetch_result($results,$result,'ys');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and ( trim(YNGroup) in ('Y','N')) " . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and ( trim(YNGroup) in ('Y','N')) " . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and ( trim(YNGroup) in ('Y','N')) " . $whereClause;
			}
			$results = $database->query($query);
			$total = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as ys from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and trim(YNFacility) = 'Y'" . $whereClause;
				} else {
					$query = "Select count(*) as ys from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and trim(YNFacility) = 'Y'" . $whereClause;
				}

			} else {
				$query = "Select count(*) as ys from spec_dmr4 where region='" . $arRegions[$i] . "' and trim(YNFacility) = 'Y'" . $whereClause;
			}
			$results = $database->query($query);
			$ys = $database->fetch_result($results,$result,'ys');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and ( trim(YNFacility) in ('Y','N'))" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and ( trim(YNFacility) in ('Y','N'))" . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and ( trim(YNFacility) in ('Y','N'))" . $whereClause;
			}
			$results = $database->query($query);
			$total = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and trim(IndSupEmp) = 'Y'" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and trim(IndSupEmp) = 'Y'" . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and trim(IndSupEmp) = 'Y'" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i]  = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and trim(GroupSupEmp) = 'Y'" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and trim(GroupSupEmp) = 'Y'" . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and trim(GroupSupEmp) = 'Y'" . $whereClause;
			}
			$results = $database->query($query);
			$returnArray[$i]  = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and ( trim(IndSupEmp) in ('Y','N'))" . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and ( trim(IndSupEmp) in ('Y','N'))" . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and ( trim(IndSupEmp) in ('Y','N'))" . $whereClause;
			}
			$results = $database->query($query);
			$total  = $database->fetch_result($results,$result,'total');
			...
			if (substr_count($arRegions[$i], "x_") > 0 ) {
				if ($useIn == false) {
					$query = "Select count(*) as total from spec_dmr4 where LEFT( CRS_Contract, 1 ) = '" . $contractNumbers . "' and ( trim(GroupSupEmp) in ('Y', 'N')) " . $whereClause;
				} else {
					$query = "Select count(*) as total from spec_dmr4 where CRS_Contract in (" . $contractNumbers . ") and ( trim(GroupSupEmp) in ('Y', 'N')) " . $whereClause;
				}

			} else {
				$query = "Select count(*) as total from spec_dmr4 where region='" . $arRegions[$i] . "' and ( trim(GroupSupEmp) in ('Y', 'N')) " . $whereClause;
			}
			$results = $database->query($query);
			$total  = $database->fetch_result($results,$result,'total');
...
function getActivityVariableArray ($variableType, $region, $provider, $year = '04') {
	...
	$results = $database->query("Select count(*) as total from spec_dmr4 where 1=1" . $whereClause );
	//echo "Select count(*) as total from spec_dmr4 where 1=1" . $whereClause ."<BR>" .  $variableType ;
	$totalRecords = $database->fetch_result($results,$result,'total');

	if ($variableType == 'numberinactivity') {
		for($i=0; $i<count($columArray); $i++) {
			$query = "Select count(*) as total from spec_dmr4 where " . $columArray[$i] . " is not null and ". $columArray[$i] . " !=0 ". $whereClause ;
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
		}
	} elseif ($variableType == 'percent') {
		for($i=0; $i<count($columArray); $i++) {
			$results = $database->query("Select count(*) as total from spec_dmr4 where " . $columArray[$i] . " is not null and ". $columArray[$i] . " !=0  ". $whereClause);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
		}
		...
		for($i=0; $i<count($columArray); $i++) {
			$query = "Select sum(" . $columArray[$i] . ") as total from spec_dmr4 where " . $columArray[$i] . " is not null and ". $columArray[$i] . " !=0  " . $whereClause;
//echo $query ." <BR>";
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
		}
		...
		for($i=0; $i<count($columArray); $i++) {
			...
			//$query = "CREATE TEMPORARY TABLE medians SELECT x." . $columArray[$i] . " medians FROM spec_dmr4 x, spec_dmr4 y	GROUP BY x." . $columArray[$i] . "	HAVING SUM(y." . $columArray[$i] . " <= x." . $columArray[$i] . ") >= COUNT(*)/2 AND SUM(y." . $columArray[$i] . " >= x." . $columArray[$i] . ") >= COUNT(*)/2;";

			//$temp_table_q = $database->query($query);

			//$query = "SELECT AVG(medians) AS median FROM medians";
			$query = "SELECT AVG(" . $columArray[$i] . ") AS mean FROM spec_dmr4 where  " . $columArray[$i] . " is not null and ". $columArray[$i] . " !=0  " . $whereClause;
			$results = $database->query($query);
...
// totalwages, ALL, ALL, 04
		...
		//$query = "Select count(*) as total from spec_dmr4 where 1=1 " . $columWagesArray[$i] . " is not null  ". $whereClause;
		//$results = $database->query($query);
		//$totalRecords = $database->fetch_result($results,$result,'total');

		for($i=0; $i<count($columWagesArray); $i++) {
		$query = "Select sum(" . $columWagesArray[$i] . ") as total from spec_dmr4 where " . $columWagesArray[$i] . " is not null and ". $columWagesArray[$i] . " !=0  ". $whereClause;
	//	echo $query ."<BR>";
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
		}
		...
		for($i=0; $i<count($columWagesArray); $i++) {
			$results = $database->query("Select avg(" . $columWagesArray[$i] . ") as total from spec_dmr4 where " . $columWagesArray[$i] . " is not null and ". $columWagesArray[$i] . " !=0  " . $whereClause);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
		}
		...
		for($i=0; $i<count($columWagesArray); $i++) {
			$query = "Select count(" . $columWagesArray[$i] . ") as total from spec_dmr4 where trim(" . $columWagesArray[$i] . ") = 'Y' ". $whereClause;
		...
		for($i=0; $i<count($columWagesArray); $i++) {
			$query = "Select count(*) as total from spec_dmr4 where trim( " . $columWagesArray[$i] . " ) IN ('N', 'Y') ". $whereClause;
		...
		for($i=0; $i<count($columWagesArray); $i++) {
			...
			$query = "Select avg(" . $columWagesArray[$i] . "/" . $columHoursArray[$i] . ") as total from spec_dmr4 where " . $columWagesArray[$i] . " is not null and ". $columWagesArray[$i] . " !=0  and " . $columHoursArray[$i] . " is not null and ". $columHoursArray[$i] . " !=0  " . $whereClause;
			//echo $query;
			$results = $database->query($query);
			$returnArray[$i] = $database->fetch_result($results,$result,'total');
		}
...
//echo $sRegion ;
	...
	$query = "Select count(*) as total from spec_dmr4 where  " . $provderWhere . " " . $region;
	//echo $query;
	$results = $database->query($query);
	$total = $database->fetch_result($results,$result,'total');
	echo "<td>&nbsp;" .$total ."</td>\n";
	if ($report == "number") {
		...
		$query = "Select count(*) as total from spec_dmr4 where " . $provderWhere . " and HrsInd is not null and HrsInd != 0" . $region;
		$results = $database->query($query);
		$HrsInd = $database->fetch_result($results,$result,'total');
		echo "<td>&nbsp;" . $HrsInd ."</td>\n";

		$query = "Select count(*) as total from spec_dmr4 where " . $provderWhere . " and HrsGroup is not null and HrsGroup != 0" . $region;
		$results = $database->query($query);
		$HrsGroup = $database->fetch_result($results,$result,'total');
		echo "<td>&nbsp;" . $HrsGroup ."</td>\n";

		$query = "Select count(*) as total from spec_dmr4 where " . $provderWhere . " and HrsFac is not null and HrsFac != 0" . $region;
		$results = $database->query($query);
		$HrsFac = $database->fetch_result($results,$result,'total');
		echo "<td>&nbsp;" . $HrsFac ."</td>\n";

		$query = "Select count(*) as total from spec_dmr4 where " . $provderWhere . " and (HrsVolunteer > 0  )" . $region;
		$results = $database->query($query);
		$HrsVolunteer = $database->fetch_result($results,$result,'total');
		echo "<td>&nbsp;" . $HrsVolunteer ."</td>\n";

		$query = "Select count(*) as total from spec_dmr4 where " . $provderWhere . " and HrsTransition is not null and HrsTransition != 0" . $region;
		$results = $database->query($query);
		...
		for($i=0; $i<count($columArray); $i++) {
			//$query = "SELECT AVG(" . $columArray[$i] . ") AS mean FROM spec_dmr4 where " . $provderWhere . "  and (" . $columArray[$i] . " > 0 or " . $columArray[$i] . " = 0) " . $region;
			$query = "SELECT AVG(" . $columArray[$i] . ") AS mean FROM spec_dmr4 where " . $provderWhere . "  and (" . $columArray[$i] . " > 0 ) " . $region;
			//echo "<td>&nbsp;" .$query ."</td>";
			$results = $database->query($query);
			echo "<td>&nbsp;" . number_format($database->fetch_result($results,$result,'mean'), 1, '.', '') . "</td>\n";
		}
		for($i=0; $i<count($columArray); $i++) {
			$query = "Select sum(" . $columArray[$i] . ") as part from spec_dmr4 where " . $provderWhere . " and " . $columArray[$i] . " > 0" . $region;

			$results = $database->query($query);
			$part = $database->fetch_result($results,$result,'part');

			$query = "Select sum(totalHours) as total from spec_dmr4 where " . $provderWhere . "  and (" . $columArray[$i] . " > 0 or " . $columArray[$i] . " = 0) " . $region;
		...
		for($i=0; $i<count($columWagesArray); $i++) {
			$results = $database->query("Select avg(" . $columWagesArray[$i] . ") as total from spec_dmr4 where " . $provderWhere . " and " . $columWagesArray[$i] . " is not null and ". $columWagesArray[$i] . " !=0  " . $region);
		...
		for($i=0; $i<count($columWagesOverArray); $i++) {
			$results = $database->query("Select count(*) as total from spec_dmr4 where " . $provderWhere . " and trim(" . $columWagesOverArray[$i] . ") in ('N','Y') " . $region);
			$totalRecords =  $database->fetch_result($results,$result,'total') ;

			$results = $database->query("Select count(*) as total from spec_dmr4 where " . $provderWhere . " and trim(" . $columWagesOverArray[$i] . ") ='Y'" . $region);
